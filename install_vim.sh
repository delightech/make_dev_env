...
cd vim74
./configure --prefix=$HOME/.vim --with-features=huge --enable-multibyte --enable-perlinterp --enable-pythoninterp --enable-rubyinterp --enable-cscope --enable-fontset --enable-fail-if-missing 
make && make install
cd ..
